    ...
    <>
      ...
      >
        <div className="flex items-center gap-2 px-6 py-6">
          <Image src="/logo.webp" alt="Digital Auxilius" width={36} height={36} className="h-9 w-auto" />
        </div>
        ...
        <div className="border-t border-surface-border px-4 py-4 text-xs text-ink-500">
          <p className="font-semibold text-ink-700">DaxCore Admin</p>
          <p>Digital Auxilius</p>
        </div>
      </aside>
    </>
  );
