...
import { useActivateApplication, useApplications, useDisableApplication } from "@/hooks/useApplications";
...
import type { Application, CreateApplicationResult } from "@/lib/types";
  ...
  return (
    <div className="space-y-6">
      ...
      <QueryState
        ...
        emptyDescription="Register your first OIDC client to let an application sign users in through DaxCore."
